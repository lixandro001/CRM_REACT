          ...
          <Scrollbars>
            ...
            <Card className={classes.card}>
              <CardContent>
                ...
                <div className={classes.line}>
                  <Typography variant="subtitle2">
                    {detailCommision.data.des_cia}
                    {detailCommision.data.id_cia}
                  </Typography>
                </div>
              ...
              <CardHeader
                title={` RESUMEN`}
                subheader={`${detailCommision.data.service}`}
              />
              ...
              <CardContent>
                <div className={classes.row}>
                  ...
                  <Typography variant="subtitle2">
                    {fCurrency(detailCommision.data.subtotal)}
                  </Typography>
                </div>
                <div className={classes.row}>
                  <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                  ...
                  <Typography variant="subtitle2">
                    {fCurrency(detailCommision.data.discount_price)}
                  </Typography>
                </div>
                <div className={classes.row}>
                  <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                  ...
                  <Typography variant="subtitle2">
                    {fCurrency(detailCommision.data.igv)}
                  </Typography>
                </div>
                ...
                <div className={classes.row}>
                  ...
                  <Box sx={{ textAlign: 'right' }}>
                    <Typography
                      ...
                      sx={{ color: 'error.main' }}
                    >
                      {fCurrency(detailCommision.data.total)}
                    </Typography>
